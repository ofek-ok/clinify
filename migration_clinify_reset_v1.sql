...
-- 6. Public Pre-Launch Signup RPC (Direct Lead & Person Creation)
...
BEGIN
  ...
  ELSE
    INSERT INTO people (
      ...
      p_full_name, COALESCE(p_phone, ''), COALESCE(v_clean_phone, ''), p_email, v_clean_email, 'lead', COALESCE(p_utm_source, 'Pre-Launch Signup')
    ) RETURNING id INTO v_person_id;
  END IF;

  -- 2. Reuse or Create Lead record
