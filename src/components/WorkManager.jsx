...
const tabs = [
  { id: 'overview', en: 'Overview', he: 'סקירה', icon: LayoutDashboard },
  { id: 'board', en: 'Table', he: 'טבלה', icon: Table2 },
  { id: 'kanban', en: 'Kanban', he: 'Kanban', icon: Columns3 },
  { id: 'timeline', en: 'Timeline', he: 'Timeline', icon: GanttChartSquare },
  { id: 'projects', en: 'Projects', he: 'פרויקטים', icon: FolderKanban },
  { id: 'customize', en: 'Customize', he: 'התאמה אישית', icon: SlidersHorizontal }
];
