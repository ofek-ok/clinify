  ...
  return (
    <div className="animate-in fade-in duration-500 space-y-6 text-start max-w-4xl mx-auto">
      <div className="flex justify-between items-center mb-6">
        ...
        <button onClick={handleSave} className="bg-violet-600 hover:bg-violet-700 text-white font-bold py-2.5 px-6 rounded-xl shadow-sm transition-all flex items-center gap-2">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                  <div>
                    ...
                    <input 
                      ...
                      className="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-lg focus:ring-2 focus:ring-violet-500/20 outline-none font-semibold text-slate-700"
                    />
                  </div>
                ...
                {field.type === 'dropdown' && (
                  <div className="mt-4 p-4 bg-slate-50 rounded-xl border border-slate-100">
                    ...
                    <input 
                      ...
                      className="w-full px-3 py-2 bg-white border border-slate-200 rounded-lg focus:ring-2 focus:ring-violet-500/20 outline-none text-sm text-slate-600"
                    />
                  </div>
                )}
        ...
        <div className="lg:col-span-1">
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200 sticky top-6">
            ...
            <div className="space-y-2.5">
              <button onClick={() => addField('text')} className="w-full flex items-center gap-3 p-3 text-start bg-slate-50 hover:bg-violet-50 border border-slate-200 hover:border-violet-200 rounded-xl transition-colors text-sm font-bold text-slate-600 hover:text-violet-700">
              ...
              <button onClick={() => addField('textarea')} className="w-full flex items-center gap-3 p-3 text-start bg-slate-50 hover:bg-violet-50 border border-slate-200 hover:border-violet-200 rounded-xl transition-colors text-sm font-bold text-slate-600 hover:text-violet-700">
              ...
              <button onClick={() => addField('tel')} className="w-full flex items-center gap-3 p-3 text-start bg-slate-50 hover:bg-violet-50 border border-slate-200 hover:border-violet-200 rounded-xl transition-colors text-sm font-bold text-slate-600 hover:text-violet-700">
                <svg className="w-5 h-5 text-slate-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path></svg>
                {t('Phone Number', 'מספר טלפון')}
              </button>
              <button onClick={() => addField('dropdown')} className="w-full flex items-center gap-3 p-3 text-start bg-slate-50 hover:bg-violet-50 border border-slate-200 hover:border-violet-200 rounded-xl transition-colors text-sm font-bold text-slate-600 hover:text-violet-700">
              ...
              <button onClick={() => addField('checkbox')} className="w-full flex items-center gap-3 p-3 text-start bg-slate-50 hover:bg-violet-50 border border-slate-200 hover:border-violet-200 rounded-xl transition-colors text-sm font-bold text-slate-600 hover:text-violet-700">
